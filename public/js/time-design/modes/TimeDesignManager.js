...
// public/js/time-design/modes/TimeDesignManager.js

import { ModeRegistry } from './ModeRegistry.js';
import { ClassicMode } from './ClassicMode.js';
import { CoreTimeMode } from './CoreTimeMode.js';
import { WakeBasedMode } from './WakeBasedMode.js';
import { SolarMode } from './SolarMode.js';
  ...
  async loadConfiguration() {
    try {
      ...
      if (!stored) {
        ...
        const legacyConfig = this.migrateLegacyData();
        if (legacyConfig) {
          await this.setMode('classic', legacyConfig);
          return;
        }
        // Set default mode
        await this.setMode('classic');
